...
export default function Contact() {
  ...
  return (
    <>
      <Wrapper
        className="text-White gap-12 flex flex-col justify-center items-center lg:flex-row pt-40 lg:pt-0"
      >
        <div className="md:px-6 py-6 text-center">
          ...
          If you&apos;re looking for a skilled FullStack web developer to help bring
